...
class TestFormatDuration:
    ...
    def test_hours(self):
        ...
        assert format_duration(7200) == "2ч"

    def test_hours_minutes(self):
        """Test formatting hours and minutes"""
        assert format_duration(5400) == "1ч 30м"
        assert format_duration(9000) == "2ч 30м"
...
class TestFormatTable:
    ...
    def test_empty_table(self):
        ...
        assert "Нет данных для отображения" in result
...
class TestFormatList:
    ...
    def test_empty_list(self):
        ...
        assert "Нет элементов" in result
...
class TestFormatProjectList:
    ...
    def test_empty_list(self):
        ...
        assert "Проекты не найдены" in result
